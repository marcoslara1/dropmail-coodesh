...
export default function Newsletter() {
  ...
  }, [email, sent, sentError]);

  const submitEnquiryForm = (e: any) => {
    e.preventDefault();
    fetch(
      `https://assets.mailerlite.com/jsonp/355556/forms/98135762886722684/subscribe?fields[email]=${email}`,
      {
        method: 'POST',
        headers: {
                ...
                >
                  <defs>
                    ...
                    >
                      ...
                      <stop stopColor="#343b42" offset="44.317%" />
              ...
              <div className="relative flex flex-col lg:flex-row justify-between items-center">
                ...
                <div className="text-center lg:text-left lg:max-w-xl">
                  ...
                  <p className="text-gray-300 text-lg mb-6">
                    Se inscreva em nossa newsletter para receber todas as
                    novidades e as melhores oportunidades que temos para
                    oferecer
                  </p>
                  ...
                  >
                    <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:mx-0">
                      {sent ? (
                        <>
                          <span className="mb-2 font-semibold text-xl bg-clip-text text-transparent bg-gradient-to-r from-[#3689b9] via-[#fff] to-[#3689b9] animate-text">
                            Obrigado!{' '}
                          </span>
                        </>
                      ) : (
                      ...
                      {sentError && (
                        <span className="mb-2 font-semibold text-sm text-red-500">
                          Ocorreu um erro!{' '}
                        </span>
                      )}
                    </div>
                    ...
                    <p className="text-sm text-gray-400 mt-3">
                      Sem spam. Voce pode se desinscrever a qualquer momento.
                    </p>
                  </form>
                </div>
              </div>
